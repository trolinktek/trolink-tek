...
const exhibitions=[
  {name:'Connected-car showcase',image:'/assets/exhibitions/trolinktek-exhibition-team-booth.jpg?v=20260821-1',alt:'TrolinkTek exhibition team at a connected-car product booth',description:'Our team presents wireless CarPlay adapters, AI boxes and display platforms to visiting buyers and channel partners.'},
  {name:'Live product demonstration',image:'/assets/exhibitions/trolinktek-exhibition-product-demo.jpg?v=20260821-1',alt:'TrolinkTek team demonstrating an electronics platform to exhibition visitors',description:'Face-to-face demonstrations help buyers review platform functions, hardware options and potential application routes.'},
  {name:'International partner meeting',image:'/assets/exhibitions/trolinktek-exhibition-partner-meeting.jpg?v=20260821-1',alt:'TrolinkTek representative meeting an international buyer at a trade show',description:'Exhibitions create a practical setting to discuss target markets, customization requirements and OEM or ODM project scope.'},
  {name:'Distributor engagement',image:'/assets/exhibitions/trolinktek-exhibition-customer-engagement.jpg?v=20260821-1',alt:'TrolinkTek exhibition team with an international visitor',description:'In-person conversations help our team understand regional demand, sales channels and after-sales expectations.'},
  {name:'Regional CarPlay showcase',image:'/assets/exhibitions/trolinktek-exhibition-carplay-booth.jpg?v=20260821-1',alt:'TrolinkTek team at a regional CarPlay product exhibition booth',description:'Product-focused exhibition displays give buyers a direct view of available platforms, form factors and connected-car applications.'}
];
